<template>
  ...
  <div class="c4-datatable" ref="toolbar">
    ...
    <v-data-table v-bind="localAttrs" :pagination.sync="compPagination">
      ...
      <template slot="no-results">
        <c4-empty text="No data to display"></c4-empty>
      </template> -->
...
<script>
import EventBus from 'c4-base/src/event-bus'
